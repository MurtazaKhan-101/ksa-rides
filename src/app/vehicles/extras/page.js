      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-6">
        <div className="grid lg:grid-cols-[1fr_340px] gap-6 items-start">
          ...
          <div className="bg-white rounded-2xl border border-gray-200 p-6 sm:p-8">
            ...
            {/* Flight number */}
            <div className="mb-6">
              <label className="flex items-center gap-1.5 text-sm font-semibold text-[#B8960C] mb-2">
                Flight number
              ...
              <div className="flex items-center gap-2">
                <div className="flex-1 relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-3 border border-gray-200 rounded-xl text-sm text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#B8960C]/30 focus:border-[#B8960C] transition-all"
                  />
                </div>
            ...
            <label className="flex items-start gap-3 cursor-pointer mb-6">
              <div className="pt-0.5">
                <input
                  ...
                  className="w-5 h-5 rounded border-gray-300 text-[#B8960C] focus:ring-[#B8960C]/30 cursor-pointer"
                />
              </div>
            ...
            <div className="mb-8">
              ...
              <textarea
                ...
                rows={4}
                className="w-full px-4 py-3 border border-gray-200 rounded-xl text-sm text-gray-900 placeholder-gray-400 resize-y focus:outline-none focus:ring-2 focus:ring-[#B8960C]/30 focus:border-[#B8960C] transition-all"
              />
            </div>
