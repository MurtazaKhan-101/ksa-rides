            ...
            <div className="bg-white rounded-2xl border border-gray-200 p-6 sm:p-8">
              ...
              <div className="space-y-5">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-400 mt-1.5">
                    Please provide a contact number so our driver can reach the
                    passenger if needed.
                  </p>
                  {errors.phone && (
            ...
            <div className="space-y-3">
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-gray-500 leading-relaxed">
                    Live ride tracking, driver info and status alerts via email
                    and the KSA Rides app.
                  </p>
                </div>
              </button>
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-gray-500 leading-relaxed">
                    Receive booking updates, driver details and ride status via
