...
function PassportContent() {
  ...
  const validate = () => {
    const errs = {};
    if (!fullName.trim())
      errs.fullName = "Full name as on passport is required";
    ...
    if (expiryDate && new Date(expiryDate) <= new Date())
      errs.expiryDate = "Passport must not be expired";
    if (!dateOfBirth) errs.dateOfBirth = "Date of birth is required";
    if (!passportFront)
      errs.passportFront = "Please upload the passport photo page";
    setErrors(errs);
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 py-6">
        ...
        <div className="mb-6">
          ...
          <p className="text-sm text-gray-500">
            Required for international transfers. Your data is securely
            encrypted.
          </p>
        </div>
        ...
        <div className="flex items-start gap-3 p-4 rounded-2xl bg-[#B8960C]/5 border border-[#B8960C]/20 mb-6">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 mt-0.5">
              Passport data is encrypted and only used for identity
              verification. We comply with international data protection
              regulations.
            </p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-6 sm:p-8 space-y-5 mb-6">
          ...
          <div className="border-t border-gray-100 pt-5">
            ...
            <p className="text-xs text-gray-500 mb-4">
              Upload a clear photo or scan of your passport&apos;s information
              page.
            </p>
        ...
        <div className="flex items-start gap-3 p-4 rounded-2xl bg-amber-50 border border-amber-200 mb-6">
          ...
          <div>
            ...
            <p className="text-xs text-gray-600 mt-0.5">
              Your passport details must match your travel documents exactly.
              Incorrect information may result in service delays.
            </p>
          </div>
        </div>
