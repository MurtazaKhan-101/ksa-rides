  ...
  return (
    <section className="bg-[#051A18] py-16 lg:py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12">
        ...
        <p className="text-xs font-bold tracking-widest text-[#B8960C] uppercase mb-4">Trust &amp; Safety</p>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {stats.map(({ label, value, detail }) => (
            <div key={label} className="bg-white/5 border border-white/10 rounded-2xl p-6">
              <p className="text-xs font-bold text-[#B8960C] uppercase tracking-wide mb-3">{label}</p>
