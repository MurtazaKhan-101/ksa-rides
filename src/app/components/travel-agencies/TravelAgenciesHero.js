...
export default function TravelAgenciesHero() {
  return (
        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-start pb-16">
          ...
          <div className="space-y-6">
            ...
            <p className="text-white/70 text-base sm:text-lg leading-relaxed max-w-lg">
              Join our network of trusted travel agencies and start offering your clients
              premium airport transfer services. Sign up today and unlock exclusive benefits
              tailored for travel professionals.
            </p>
            ...
            <div className="grid sm:grid-cols-2 gap-3">
              <div className="bg-white/8 border border-white/15 rounded-xl p-5">
                <div className="flex items-center justify-between mb-3">
                  <span className="text-sm font-bold text-white">Dedicated Support</span>
                ...
                <p className="text-white/50 text-xs">Live assistance for you and your travellers.</p>
              </div>
              <div className="bg-white/8 border border-white/15 rounded-xl p-5">
                <div className="flex items-center justify-between mb-3">
            ...
            <div className="flex flex-wrap items-center gap-4">
              ...
              <a href="#benefits"
                ...
                Discover all benefits <ArrowRight className="h-4 w-4" />
              </a>
            </div>
          </div>
